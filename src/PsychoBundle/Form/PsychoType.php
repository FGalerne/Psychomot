...
class PsychoType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder
            ...
            ->add('image4')
            ->add('file4', 'file', array('label' => 'Modifier la première image de la biographie', 'required' => false))
            ->add('txtPsy2',  'textarea', array('attr' => array('rows' => '15')))
            ->add('image5')
            ->add('file5', 'file', array('label' => 'Inserer/modifier la deuxime image de la biographie', 'required' => false))
            ->add('titleConsult')
